...
class BaseDevice(ABC):
    ...
    def _generate_default_name(self) -> str:
        ...
        # Fix EWneo capitalization (should be EWneo, not Ewneo)
        type_name = type_name.replace("Ewneo", "EWneo")
        short_serial = self.serial_number[-6:] if len(self.serial_number) > 6 else self.serial_number
    ...
    def device_info_dict(self) -> Dict[str, Any]:
        ...
        return {
            "identifiers": {("eldat_plugin", self.serial_number)},
            "name": self.name,
            "manufacturer": "ELDAT",
    ...
    def _get_model_name(self) -> str:
        ...
        # Fix EWneo capitalization (should be EWneo, not Ewneo)
        base_name = base_name.replace("Ewneo", "EWneo")
