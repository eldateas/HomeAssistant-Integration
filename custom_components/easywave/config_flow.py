...
from .config_flow_subentry import (
    EasywaveNeoActuatorSubentryFlowHandler,
    EasywaveNeoSensorSubentryFlowHandler,
    EasywaveReceiverSubentryFlowHandler,
...
class EasywaveConfigFlow(ConfigFlow, domain=DOMAIN):
    ...
    def async_get_supported_subentry_types(
        ...
        return {
            ...
            SUBENTRY_TYPE_EASYWAVE_RECEIVER: EasywaveReceiverSubentryFlowHandler,
            SUBENTRY_TYPE_EASYWAVE_NEO_ACTUATOR: EasywaveNeoActuatorSubentryFlowHandler,
        }
