...
class EasywaveDeviceFlowMixin:
    ...
    def _is_duplicate(
        ...
        *,
        ...
        serial_key = {
            ...
            ENTRY_TYPE_RECEIVER: CONF_RECEIVER_SERIAL,
            ENTRY_TYPE_NEO_ACTUATOR: CONF_ACTUATOR_SERIAL,
        }.get(entry_type)
    ...
    async def _async_save_device(
        ...
        if bucket is None:
            return self.async_create_entry(
                title=await async_bucket_subentry_title(self.hass, bucket_type),
    ...
    def _next_default_name(self, entry_type: str) -> str:
        ...
        if entry_type == ENTRY_TYPE_TRANSMITTER:
            label = "Sender" if german else "Transmitter"
