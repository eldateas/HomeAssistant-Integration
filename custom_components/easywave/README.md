...
- ✅ **Persistente Speicherung** in `managed_devices.json`
- ✅ **Automatische Backups** bei jedem Speichern
- ✅ **Automatische Migration** von alten Konfigurationsformaten
- ✅ **Keine Datenverluste** bei Plugin-Updates
- ✅ **Keine Blacklist/Whitelist mehr** - nur noch eine zentrale Geräteverwaltung

→ Siehe [MIGRATION_NOTES.md](MIGRATION_NOTES.md) für Details zur neuen Version

## 🆕 Version 2.0 - Vereinfachte Geräteverwaltung

**Wichtige Änderungen:**
- **Zentrale Konfiguration**: Nur noch `managed_devices.json` statt mehrerer Dateien
- **Automatische Wiederherstellung**: Geräte werden beim Start automatisch wiederhergestellt
- **Intelligente Fehlerbehandlung**: Nicht wiederherstellbare Geräte werden automatisch entfernt
- **Blacklist entfernt**: Geräte sind entweder in der Konfiguration oder nicht
- **Laufzeit-Verwaltung**: Keine persistenten Black-/Whitelists mehr

**Migration erfolgt automatisch beim ersten Start!**
...
- RX11 USB-sTransceiver (VID: 0x155A, PID: 0x1006 oder 0x1014)
