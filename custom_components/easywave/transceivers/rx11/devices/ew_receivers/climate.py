    ...
    async def set_state(self, channel: int, state: Any) -> bool:
        ...
        try:
            ...
            _LOGGER.info("EW Climate Receiver %s channel %d: mode=%s, target=%.1f°C", 
                       self.serial_number, channel, mode, target_temp or 0)
            return True
